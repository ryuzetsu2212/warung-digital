<div class="min-h-screen flex items-center justify-center bg-[#0c0f1a] px-4 py-12 relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-md w-full">
        ...
        <div class="text-center mb-10">
            ...
            <h1 class="text-2xl font-black text-white mb-2">Warung Digital</h1>
        ...
        <div class="bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl">
            ...
            <form wire:submit.prevent="login" class="space-y-5">
                <!-- Email Field -->
                <div>
                    <label for="email" class="block text-xs font-bold text-slate-300 uppercase tracking-wider mb-2.5">
                        Email
                    </label>
                    <div class="relative">
                        <span class="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-500 text-sm">✉️</span>
                        <input 
                            type="email" 
                            id="email"
                            wire:model="email"
                            class="w-full bg-slate-950/40 border border-white/10 rounded-xl pl-11 pr-4 py-3.5 text-white placeholder-slate-600 text-sm focus:outline-none focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/20 transition-all @error('email') border-red-500/50 @enderror"
                ...
                <div class="flex items-center">
                    <input 
                        ...
                        id="remember"
                        wire:model="remember"
                        class="w-4 h-4 accent-amber-500 border border-white/20 bg-slate-950/40 rounded cursor-pointer"
                    >
                    <label for="remember" class="ml-2.5 text-sm text-slate-300 font-medium cursor-pointer">
                        Ingat saya
                    </label>
                </div>
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center">
                    <span class="px-3 bg-white/5 text-xs text-slate-500 font-medium">Belum punya akun?</span>
                </div>
            </div>
