<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 px-4 py-12 relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-md w-full">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-black text-white tracking-tight mb-1.5">Daftar Akun</h1>
            <p class="text-slate-400 text-sm font-medium">Buat akun untuk reservasi & pesanan</p>
        </div>
        ...
        <div class="bg-slate-900/60 border border-white/10 backdrop-blur-2xl rounded-3xl p-8 shadow-2xl shadow-black/50">
            ...
            @if($successMessage)
                <div class="mb-6 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded-2xl p-4 flex items-start gap-3 text-sm">
                    <svg class="w-5 h-5 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <form wire:submit.prevent="register" class="space-y-5">
                ...
                <div>
                    <label class="block text-xs font-bold text-slate-300 uppercase tracking-wider mb-2">Email <span class="text-slate-500 normal-case font-medium">(Opsional)</span></label>
                    <div class="relative">
                        <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 text-sm">📧</span>
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center">
                    <span class="px-4 bg-slate-900 text-xs text-slate-400 font-medium">Sudah punya akun?</span>
                </div>
            </div>
